...
import in.lastlocal.information.fragment.UserManualFragment;
import in.lastlocal.information.fragment.UserManualFragmentMarathi;
import in.lastlocal.mumbaitraffic.R;

/**
 * Created by USER on 21-Jun-15.
 */
public class UserManulActivity  extends AppCompatActivity implements OnFragmentInteractionListener {

    private int optionSelected = AppConstant.ANIMATE_X;
    private UserManualFragment mFirstFragment;
    ...
    public void onFragmentInteraction(View v) {
        if (getFragmentManager().getBackStackEntryCount() == 0) {
            ...
            FragmentTransactionExtended fragmentTransactionExtended = new FragmentTransactionExtended(this, fragmentTransaction, mFirstFragment, new UserManualFragmentMarathi(), R.id.fl_fragment_cantainer);
